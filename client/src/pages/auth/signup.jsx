...
const SignUp = () => {
  ...
  return (
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col">
              <label className="mb-2 font-medium text-gray-200">Nombre</label>
            ...
            <div className="flex flex-col">
              <label className="mb-2 font-medium text-gray-200">Apellido</label>
    ...
    bg-white/10
          ...
          {/* DNI */}
          <div className="flex flex-col">
            <label className="mb-2 font-medium text-gray-200">D.N.I</label>
    ...
    bg-white/10
          ...
          {/* Email */}
          <div className="flex flex-col">
            <label className="mb-2 font-medium text-gray-200">Email</label>
    ...
    bg-white/10
          ...
          {/* Telefono */}
          <div className="flex flex-col">
            <label className="mb-2 font-medium text-gray-200">Teléfono</label>
