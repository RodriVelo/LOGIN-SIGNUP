 ...
 const heandleGuardarCanchaNueva = async (form) => {
  ...
  <div className="flex items-center gap-2.5 flex-wrap">
    {[
      ...
      <div key={label} className="flex-1 min-w-[72px] bg-zinc-800/60 border border-zinc-700 rounded-xl px-3 py-2.5 text-center">
