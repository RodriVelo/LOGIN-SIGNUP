export default function TabsCanchas({
  ...
  return (
    <div className="flex flew-row justify-between">
      ...
      {esAdmin &&(
        <div>
        <button onClick={()=>{setModalCanchaNueva(true)}} className="px-4 py-2 rounded-lg text-sm font-semibold border transition-all duration-150 bg-zinc-900 border-zinc-800 text-zinc-400 hover:text-zinc-200 hover:border-zinc-600">
          Agregar cancha
        </button>
      </div>
      )}
