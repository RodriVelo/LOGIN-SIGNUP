...
export default function CanchasClient() {
  ...
  const turnosLibres = turnosCancha.filter((t) => t.estado === "disponible").length;
        ...
        >
          ...
          >
            ...
            <div className="text-center">
              <h2 className="text-lg font-bold text-white mb-1">¡Reserva confirmada!</h2>
              <p className="text-zinc-400 text-sm">Tu turno fue reservado con éxito</p>
            </div>
            ...
            <div className="w-full bg-zinc-800/80 border border-zinc-700 rounded-xl divide-y divide-zinc-700 text-sm">
              ...
              <div className="flex justify-between items-center px-4 py-3">
                ...
                <span className="text-white font-semibold">{formatFecha(exito.fecha)}</span>
              </div>
              <div className="flex justify-between items-center px-4 py-3">
                <span className="text-zinc-400">Horario</span>
                <span className="text-white font-semibold">{exito.hora} hs</span>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500 mt-0.5">Turnos disponibles en tiempo real</p>
            </div>
          </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-4 sm:px-6 py-5 border-b border-zinc-800">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-2.5 text-center min-w-[72px]">
                      <p className="text-2xl font-black text-blue-400 leading-none">{turnosLibres}</p>
                ...
                <div className="p-4 sm:p-6">
                  {loadingTurnos ? (
                    ...
                    <div className="flex flex-col items-center gap-2 py-16 text-zinc-500">
                      ...
                      <p className="text-sm font-medium">No hay turnos disponibles para esta fecha</p>
                    </div>
                  ) : (
                          ...
                          >
                            ...
                            {ocupado ? (
                              <div className="flex items-center justify-center gap-1.5 bg-zinc-700/40 border border-zinc-700 rounded-lg py-1.5">
                                ...
                                <span className="text-xs text-zinc-500 font-semibold">Reservado</span>
                              </div>
                            ) : (
                              <button
